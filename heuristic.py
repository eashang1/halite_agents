...
def agent(obs, config):
    ...
    # Halite being spent this round
    cost = 0

    # Ships converted this round
    converted = 0

    free = set()
    for x in range(21):
        for y in range(21):
            if (board.cells[Point(x, y)].halite >= 200 and not any(
